...
MillerPhaseCoordSys::MillerPhaseCoordSys( ParmParse&                    a_pp,
                                          const CFG::MillerCoordSys&    a_mag_coords,
...
void
MillerPhaseCoordSys::defineBoundaries()
{
...
void
MillerPhaseCoordSys::blockRemapping(RealVect&       a_xi_valid,
                                    int&            a_n_valid,
...
void
MillerPhaseCoordSys::getDecompositionParams( ParmParse& a_pp )
{
