...
RectangularTorusPhaseCoordSys::RectangularTorusPhaseCoordSys( ParmParse&                    a_pp,
                                          const CFG::RectangularTorusCoordSys&    a_mag_coords,
...
void
RectangularTorusPhaseCoordSys::defineBoundaries()
{
...
void
RectangularTorusPhaseCoordSys::blockRemapping(RealVect&       a_xi_valid,
                                    int&            a_n_valid,
...
void
RectangularTorusPhaseCoordSys::getDecompositionParams( ParmParse& a_pp )
{
