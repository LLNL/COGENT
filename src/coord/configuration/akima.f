...
* Evaluates the polynomial.
              ...
              ELSE IF (EVAL_MODE .EQ. 1) THEN
                 Q0 = P00 + V* (P01+V* (P02+V*P03))
                 Q1 = P10 + V* (P11+V* (P12+V*P13))
                 Q2 = P20 + V* (P21+V* (P22+V*P23))
                 Q3 = P30 + V* (P31+V* (P32+V*P33))
                 ZII = Q1 + U*(2.0*Q2 + 3.0*Q3*U)
              ELSE IF (EVAL_MODE .EQ. 2) THEN
                 Q0 = P01 + V* (2.0*P02 + 3.0*P03*V)
                 Q1 = P11 + V* (2.0*P12 + 3.0*P13*V)
                 Q2 = P21 + V* (2.0*P22 + 3.0*P23*V)
                 Q3 = P31 + V* (2.0*P32 + 3.0*P33*V)
                 ZII = Q0 + U* (Q1+U* (Q2+U*Q3))
              ENDIF
* End of Case 1
