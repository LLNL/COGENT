...
inline
KineticFunction& SlabPhaseBC::radialInflowFunc( const Side::LoHiSide& a_side )
{
   if (a_side==Side::Lo) {
...
inline
KineticFunction& SlabPhaseBC::poloidalInflowFunc( const Side::LoHiSide& a_side )
{
   if (a_side==Side::Lo) {
...
#if CFG_DIM==3
inline
KineticFunction& SlabPhaseBC::toroidalInflowFunc( const Side::LoHiSide& a_side )
{
   if (a_side==Side::Lo) {
...
inline
KineticFunction& SlabPhaseBC::vParallelInflowFunc( const Side::LoHiSide& a_side )
{
   if (a_side==Side::Lo) {
...
inline
KineticFunction& SlabPhaseBC::muInflowFunc( const Side::LoHiSide& a_side )
{
   if (a_side==Side::Lo) {
...
inline
KineticFunction& SlabPhaseBC::inflowFunc( const int& a_dir,
                                              const Side::LoHiSide& a_side )
{
   ...
   if (a_dir==RADIAL_DIR) {
      ...
      MayDay::Error( "SlabPhaseBC: BCs not implemented!" );
   }
   return *(inflow_func);
}
...
SlabPhaseBC::SlabPhaseBC( const std::string& a_name,
                                ParmParse& a_pp,
...
inline
void SlabPhaseBC::fillInflowData( KineticSpeciesPtrVect& a_bdry_data,
...
void SlabPhaseBC::apply( KineticSpecies& a_species_comp,
...
void SlabPhaseBC::printParameters() const
{
   if (procID()==0) {
      std::cout << std::endl;
      std::cout << "SlabPhaseBC ================================" << std::endl;
...
inline
void SlabPhaseBC::parseParameters( ParmParse& a_pp )
{
