...
SlabPotentialBC::SlabPotentialBC()
...
SlabPotentialBC::SlabPotentialBC( const std::string& a_name,
                                  ParmParse& a_pp,
...
void
SlabPotentialBC::setBCType(const int a_block_number,
                           const int a_dir,
                           const int a_side,
                           const int a_type)
{
   if ( a_dir == RADIAL_DIR ) {
      if ( a_side == 0 ) {
         ...
         MayDay::Error("SlabPotentialBC::setBCType(): Invalid side argument");
      }
   }
      ...
      MayDay::Error("SlabPotentialBC::setBCType(): Invalid direction argument");
   }
}
...
int
SlabPotentialBC::getBCType(const int a_block_number,
                           const int a_dir,
                           const int a_side) const
{
   ...
   if ( a_dir == RADIAL_DIR ) {
      if ( a_side == 0 ) {
         ...
         MayDay::Error("SlabPotentialBC::getBCType(): Invalid side argument");
      }
   }
   else if ( a_dir == POLOIDAL_DIR ) {
      if ( a_side == 0 ) {
      ...
      MayDay::Error("SlabPotentialBC::getBCType(): Invalid direction argument");
   }
...
void
SlabPotentialBC::setBCValue(const int    a_block_number,
                            const int    a_dir,
                            const int    a_side,
                            const double a_value)
{
   if ( a_dir == RADIAL_DIR ) {
      if ( a_side == 0 ) {
         ...
         MayDay::Error("SlabPotentialBC::setBCValue(): Invalid side argument");
      }
   }
   else if ( a_dir == POLOIDAL_DIR ) {
      if ( a_side == 0 ) {
      ...
      MayDay::Error("SlabPotentialBC::setBCValue(): Invalid direction argument");
   }
}
...
double
SlabPotentialBC::getBCValue(const int a_block_number,
                               const int a_dir,
                               const int a_side) const
{
   ...
   if ( a_dir == RADIAL_DIR ) {
      if ( a_side == 0 ) {
         ...
         MayDay::Error("SlabPotentialBC::getBCValue(): Invalid side argument");
      }
   }
   else if ( a_dir == POLOIDAL_DIR ) {
      if ( a_side == 0 ) {
      ...
      MayDay::Error("SlabPotentialBC::getBCValue(): Invalid direction argument");
   }
...
void
SlabPotentialBC::setBCFunction(const int                          a_block_number,
                                  const int                          a_dir,
                                  const int                          a_side,
                                  const RefCountedPtr<GridFunction>& a_function)
{
   if ( a_dir == RADIAL_DIR ) {
      if ( a_side == 0 ) {
         ...
         MayDay::Error("SlabPotentialBC::setBCFunction(): Invalid side argument");
      }
   }
   else if ( a_dir == POLOIDAL_DIR ) {
      if ( a_side == 0 ) {
      ...
      MayDay::Error("SlabPotentialBC::setBCFunction(): Invalid direction argument");
   }
}
...
SlabPotentialBC::getBCFunction( const int                          a_block_number,
                                   const int                          a_dir,
                                   const int                          a_side ) const
{
   ...
   if ( a_dir == RADIAL_DIR ) {
      if ( a_side == 0 ) {
         ...
         MayDay::Error("SlabPotentialBC::getBCFunction(): Invalid side argument");
      }
   }
   else if ( a_dir == POLOIDAL_DIR ) {
      if ( a_side == 0 ) {
      ...
      MayDay::Error("SlabPotentialBC::getBCFunction(): Invalid direction argument");
   }
...
void
SlabPotentialBC::apply( const MultiBlockLevelGeom& a_geom,
                           ...
                           FArrayBox&                 a_phi ) const
{
   ...
   if ( a_dir == RADIAL_DIR ) {
      if ( a_side == 0 ) {
         ...
         MayDay::Error("SlabPotentialBC::apply(): Invalid side argument");
      }
   }
   else if ( a_dir == POLOIDAL_DIR ) {
      if ( a_side == 0 ) {
      ...
      MayDay::Error("SlabPotentialBC::apply(): Invalid direction argument");
   }
...
void SlabPotentialBC::printParameters() const
{
   if (procID()==0) {
      std::cout << std::endl;
      std::cout << "SlabPotentialBC ================================" << std::endl;
...
inline
void SlabPotentialBC::parseParameters( ParmParse& a_pp )
{
   for (int i=0; i<m_bc_type.size(); i++) {
      ...
      if (bc_type == "dirichlet") {
         ...
         MayDay::Error("SlabPotentialBC::parseParameter(): Illegal potential bc type");
      }
