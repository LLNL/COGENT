...
#################################################
###  This is the Chfautoix processer.
### Interface is
### sub ChfAutoixProc::procChfAutoixMacros(inputfile, outputfile,
###                                SpaceDim, debug)
###
###  reads in input file 
#################################################

package ChfAutoixProc;
use vars qw(@ISA @EXPORT @EXPORT_OK %EXPORT_TAGS $VERSION);
use Exporter;
$VERSION = 1.23;
@ISA = qw(Exporter);
@EXPORT = qw(&procChfAutoixMacros);
@EXPORT_OK = qw(&procChfAutoixMacros);
@EXPORT_TAGS= ();

sub ChfAutoixProc::procChfAutoixMacros
{
