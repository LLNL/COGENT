...
/***/
void
slowcoarsenStuff(LevelData<EBCellFAB>               & a_acoefCoar,
...
/****/
slowEBCOFactory::
slowEBCOFactory(const Vector<EBLevelGrid>&                                  a_eblgs,
              ...
              if (hasCoarser)
                {
                  ...
                  slowcoarsenStuff(*acoefCoar, *bcoefCoar, *bcoefIrregCoar, eblgFine, eblgCoar,
        ...
        bool                 a_homoOnly)
{
  ...
  //
  slowEBCO* newOp = new slowEBCO(EBLevelGrid(), eblgMGLevel, EBLevelGrid(), eblgCoarMG, quadCFI,
...
AMRnewOp(const ProblemDomain& a_domainFine)
{
  ...
  bool layoutChanged = true;
  slowEBCO* newOp = new slowEBCO(eblgFine, eblgMGLevel, eblgCoar, eblgCoarMG, m_quadCFI[ref],
