...
/// constructor
MultiBlockLevelCopierCenter::MultiBlockLevelCopierCenter(const MultiBlockLevelGeom*  a_geomPtr,
...
/// destructor
MultiBlockLevelCopierCenter::~MultiBlockLevelCopierCenter()
{
  undefine();
}
...
void
MultiBlockLevelCopierCenter::define(const MultiBlockLevelGeom*  a_geomPtr,
                                    const DisjointBoxLayout&    a_dstDisjointLayout,
                                    const IntVect&              a_ghostVect,
                                    int                         a_order)
{
