...
#include "ZZSVortexIBCF_F.H"

#include "NamespaceHeader.H"

// Null constructor
ZZSVortexIBC::ZZSVortexIBC()
{
  m_isFortranCommonSet = false;
}

// Constructor which defines parameters used by Fortran routines
ZZSVortexIBC::ZZSVortexIBC(Real&           a_smallPressure,
                     const Real&     a_gamma,
...
void ZZSVortexIBC::setFortranCommon(Real&           a_smallPressure,
                                 const Real&     a_gamma,
                                 const Real&     a_ambientDensity,
                                 const int&      a_pressure,
                                 const Vector<RealVect>& a_center,
                                 ...
                                 const Real&     a_artvisc)
{
  ...
  FORT_ZZSVORTEXSETF(CHF_REAL(a_smallPressure),
...
PhysIBC* ZZSVortexIBC::new_physIBC()
{
  ZZSVortexIBC* retval = new ZZSVortexIBC();
...
void ZZSVortexIBC::initialize(LevelData<FArrayBox>& a_U)
{
...
// Set boundary fluxes
void ZZSVortexIBC::primBC(FArrayBox&            a_WGdnv,
...
void ZZSVortexIBC::setBdrySlopes(FArrayBox&       a_dW,
                                const FArrayBox& a_W,
                                const int&       a_dir,
                                const Real&      a_time)
{
...
void ZZSVortexIBC::artViscBC(FArrayBox&       a_F,
                            const FArrayBox& a_U,
