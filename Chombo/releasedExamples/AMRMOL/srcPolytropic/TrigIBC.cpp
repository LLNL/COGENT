...
TrigIBC::TrigIBC(Real&           a_smallPressure,
                 const Real&     a_gamma,
...
void TrigIBC::setFortranCommon(Real&           a_smallPressure,
                               const Real&     a_gamma,
                               const Real&     a_ambientDensity,
                               const int&      a_pressure,
                               const Real&     a_artvisc)
...
PhysIBC* TrigIBC::new_physIBC()
{
  TrigIBC* retval = new TrigIBC();
...
void TrigIBC::initialize(LevelData<FArrayBox>& a_U)
{
...
// Set boundary fluxes
void TrigIBC::primBC(FArrayBox&            a_WGdnv,
...
void TrigIBC::setBdrySlopes(FArrayBox&       a_dW,
                                const FArrayBox& a_W,
                                const int&       a_dir,
                                const Real&      a_time)
{
...
void TrigIBC::artViscBC(FArrayBox&       a_F,
                         const FArrayBox& a_U,
