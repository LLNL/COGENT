      ...
      if (!testBox.isEmpty())
        {
          ...
          newLo[a_reflectDir] = 2*a_reflectCoord -testBox.bigEnd(a_reflectDir) -1;
          newHi[a_reflectDir] = 2*a_reflectCoord -testBox.smallEnd(a_reflectDir) -1;
  ...
  for (dit.begin(); dit.ok(); ++dit)
    {
      ...
      oldLo[a_reflectDir] = 2*a_reflectCoord -thisBox.bigEnd(a_reflectDir) -1;
      oldHi[a_reflectDir] = 2*a_reflectCoord -thisBox.smallEnd(a_reflectDir) -1;
