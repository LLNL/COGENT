                      ...
                      const bool                a_gridUe_output)
{
   ...
   //Create file for COGENT mapping output
   char file_name[80];
   sprintf(file_name, "%s", m_mapping_file_name.c_str());
   //sprintf(file_name, m_mapping_file_name.c_str());
   FILE* fcogent;
   fcogent = fopen(file_name, "w");

   //Create file for gridUE output
   char file_name_ue[80];
   sprintf(file_name_ue, "%s%s",m_mapping_file_name.c_str(),"_UE");
   FILE* fgridue;
   if (a_gridUe_output) fgridue = fopen(file_name_ue, "w");
   ...
   for (int block_id(0); block_id<num_blocks; ++block_id) {
      ...
      if (block_id == LCORE) {
         ...
         cout << "Writing lcore coordinates" << endl;
         fprintf(fcogent, "lcore %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-half_mcore, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "lcore %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-half_mcore, m_ext_pol);
         ...
         for (BoxIterator bit(grown_box);bit.ok();++bit) {
            ...
            if (a_gridUe_output) {
               double psi = getPsi(phys_coord);
               fprintf(fgridue, "%20.12e %20.12e %20.12e %20.12e %20.12e \n", extended_data(iv,0), extended_data(iv,1), RB[0], RB[1], psi);
            }
         ...
         cout << "Writing rcore coordinates" << endl;
         fprintf(fcogent, "rcore %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-half_mcore, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "rcore %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-half_mcore, m_ext_pol);
         ...
         cout << "Writing lcsol coordinates" << endl;
         fprintf(fcogent, "lcsol %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-half_mcore, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "lcsol %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-half_mcore, m_ext_pol);
         ...
         cout << "Writing rcsol coordinates" << endl;
         fprintf(fcogent, "rcsol %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-half_mcore, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "rcsol %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-half_mcore, m_ext_pol);
         ...
         cout << "Writing lsol coordinates" << endl;
         fprintf(fcogent, "lsol %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-m_ext_pol, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "lsol %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-m_ext_pol, m_ext_pol);
         ...
         cout << "Writing rsol coordinates" << endl;
         fprintf(fcogent, "rsol %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-m_ext_pol, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "rsol %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-m_ext_pol, m_ext_pol);
         ...
         cout << "Writing lpf" << endl;
         fprintf(fcogent, "lpf %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-m_ext_pol, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "lpf %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-m_ext_pol, m_ext_pol);
         ...
         cout << "Writing rpf" << endl;
         fprintf(fcogent, "rpf %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-m_ext_pol, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "rpf %d %d %d %d \n", box.size(0)-m_ext_rad, m_ext_rad, box.size(1)-m_ext_pol, m_ext_pol);
         ...
         cout << "Writing mcore coordinates" << endl;
         fprintf(fcogent, "mcore %d %d %d %d \n", lcore_box.size(0)-m_ext_rad, m_ext_rad, 2*half_mcore+1, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "mcore %d %d %d %d \n", lcore_box.size(0)-m_ext_rad, m_ext_rad, 2*half_mcore+1, m_ext_pol);
         ...
         cout << "Writing mcsol coordinates" << endl;
         fprintf(fcogent, "mcsol %d %d %d %d \n", lcsol_box.size(0)-m_ext_rad, m_ext_rad, 2*half_mcore+1, m_ext_pol);
         if (a_gridUe_output) fprintf(fgridue, "mcsol %d %d %d %d \n", lcsol_box.size(0)-m_ext_rad, m_ext_rad, 2*half_mcore+1, m_ext_pol);
      ...
      //Create individual block output
      if (m_block_output) {
   ...
   if (a_gridUe_output) fclose(fgridue);
...
double
GridOutput::getPsi(const RealVect& a_phys_coord)
{
   
   return m_block_mapping.getMagneticFluxFromDCT( a_phys_coord );
